...
public class PrimeiroFx extends Application{
	...
	public void start(Stage primaryStage) throws Exception {
		...
		botaoC.setOnAction(e -> System.exit(0)); // FECHA A APLIACAÇÃO OMGGG
		
		VBox box = new VBox(); // organiza os elementos na vertical
		
		
		box.setAlignment(Pos.TOP_CENTER); // meio da tela os botões
		box.setSpacing(10); // espaçamento entre eles
